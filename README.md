...
# 🐦 Flappy Bird — A Pygame Clone  

A **Flappy Bird** clone built using **Python** and **Pygame**, featuring a **menu system, smooth animations, high score tracking, and sound effects**.  

## 🚀 Features  

✅ **Menu System** – Start screen and Game Over screen with high score display.  
✅ **Smooth Animations** – Bird rotation and gravity-based motion.  
✅ **Dynamic Pipes** – Randomized gap positions for increasing difficulty.  
✅ **High Score Tracking** – Saves and loads the highest score.  
✅ **Background & Sound Effects** – Adds an immersive experience.  
✅ **Collision Detection** – Pipes and ground interactions.  
...
- **Press `SPACE` to flap** the bird upwards.  
